...
@section('content')
    <div class="box-rating">
        <div class="card border-0 shadow mt-3 content-rating " data-aos="zoom-in" data-aos-duration="1000"
            ...
            <form action="{{ route('storeRating') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="wraper">
                    ...
                    <div class="form-group comment">
                        <input type="comment" class="form-control" id="comment" name="comment" aria-describedby="emailHelp"
                            placeholder="Add Comment...">
                        <small id="emailHelp" class="form-text text-muted comdetail">We'll never share your Comment with
                            anyone else.</small>
                    </div>
